...
- **Position sizing shrinks, not grows, in Extreme Greed.** Mean position size is *smallest* during Extreme Greed (approx. $3,113) and largest during Fear (approx. $7,818) — the opposite of the "traders lever up into greed" assumption. This account cohort appears to size down, not up, at emotional extremes.
